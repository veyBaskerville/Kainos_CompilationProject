...
public class _11thGuidedExercise extends AppCompatActivity {
    EditText name, age;
    ...
    Intent intent;
    Adapter adapter;
    String[] jobList = {"Software Developer", "Software QA", "System Analyst", "Data Scien`tist"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout._11th_guided_exercise);
    ...
    public void init(){
        ...
        intent = new Intent(this, _11thGuidedExerciseResult.class);
